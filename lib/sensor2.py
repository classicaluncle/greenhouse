...
pin                          = 17
sensor_name                  = "sensor2"
hist_temperature_file_path   = "/home/pi/Greenhouse/data/temperature_" + sensor_name + "_log_" + str(date.today().year) + ".csv"
latest_temperature_file_path = "/home/pi/Greenhouse/data/temperature_" + sensor_name + "_latest_value.csv"
hist_humidity_file_path      = "/home/pi/Greenhouse/data/humidity_" + sensor_name + "_log_" + str(date.today().year) + ".csv"
latest_humidity_file_path    = "/home/pi/Greenhouse/data/humidity_" + sensor_name + "_latest_value.csv"
